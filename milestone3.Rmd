...
```{r}
# read tidy data
fatalcrashes <- read.csv(here::here("T11_Wed_reprex_Milestone3/data/cleaned_fatalcrashes.csv"))
fatalities <- read.csv(here::here("T11_Wed_reprex_Milestone3/data/cleaned_fatalities.csv"))
head(fatalcrashes)
head(fatalities)
```
