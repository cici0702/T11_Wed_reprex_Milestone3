...
ggplot(accident_car_type_count, 
  ...
  ggtitle("Number of Fatal Accidents with Different Car Type in Different State")

```

From the graph above:
 -NSW is the state with highest number of fatal accidents
 -follows by Qld and Vic. 
...
```{r, eval=TRUE, echo=TRUE}
#no. of fatal accidents in different district **with** NA value
...
#no. of fatal accidents in different district **without** NA value
